<?php
	...
	$login = new Login();
	$_SESSION['linkup_userid'] = isset($_SESSION['linkup_userid']) ? $_SESSION['linkup_userid'] : 0;
	
	$user_data = $login->check_login($_SESSION['linkup_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['first_name'])){
			...
			$settings_class->save_settings($_POST,$_SESSION['linkup_userid']);

		}else{

			$post = new Post();
			$id = $_SESSION['linkup_userid'];
	...
	<body style="font-family: tahoma; background-color: #d0d8e4;">
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<?php 
					if($user_data['userid'] == $_SESSION['linkup_userid']){
